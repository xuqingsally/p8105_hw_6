...
```{r}
library(ggmap)
nyc_inspections$location<- paste0(nyc_inspections$street, ", ", nyc_inspections$boro, ", CT ", nyc_inspections$zipcode)
geo <- geocode(location = nyc_inspections$location, output="latlon", source="google")
